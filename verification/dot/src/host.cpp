...
constexpr void initialize_data(Number *x, Number *y, std::uint64_t size) {
...
int main(int argc, char *argv[]) {
    ...
    xrt::kernel mm2s = xrt::kernel(device, uuid, "dot_mm2s");
    xrt::kernel s2mm = xrt::kernel(device, uuid, "dot_s2mm");
    ...
    result = cblas_sdot(args.size, x, 1, y, 1);
